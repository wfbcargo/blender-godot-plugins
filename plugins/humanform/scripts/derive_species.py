...
SPECIES = {
    "elf": {
        ...
        "look": {"head": {"shape": "invertedtriangular", "shape_weight": 0.6,
                 ...
                 "skin": {"palette": [[0.86, 0.74, 0.65], [0.84, 0.69, 0.58], [0.66, 0.50, 0.39], [0.45, 0.32, 0.25]],
                          "regions_off": []},
    ...
    "halfling": {
        ...
        "look": {"head": {"shape": "round", "shape_weight": 0.5,
                 ...
                 "skin": {"palette": [[0.88, 0.74, 0.62], [0.80, 0.62, 0.49], [0.62, 0.45, 0.34], [0.46, 0.33, 0.25]],
                          "regions_off": []},
    ...
    "gnome": {
        ...
        "look": {"head": {"shape": "round", "shape_weight": 0.7,
                 ...
                 "skin": {"palette": [[0.87, 0.74, 0.63], [0.82, 0.62, 0.50], [0.64, 0.46, 0.35], [0.47, 0.33, 0.25]],
                          "regions_off": []},
    ...
    "satyr": {
        ...
        "look": {"head": {"shape": "triangular", "shape_weight": 0.35,
                 ...
                 # a goat's hind limb by its measured segment ratios (humanform.legs RATIOS "caprine": Mt:F 0.80,
                 # inside the cursorial-ungulate band, on the very short digits of an unguligrade foot)
                 "legs": {"plan": "digitigrade", "ratios": "caprine"},
