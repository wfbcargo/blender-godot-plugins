# History: rounds one to three (September 2026)

This was NEXT.md until the end of the third round (the figure study). It is kept as the record of what
was built, merged and learned, with every number. The current handoff is [NEXT.md](NEXT.md).

---

# (was) Next: the remaining work
